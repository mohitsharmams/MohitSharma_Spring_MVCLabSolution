...
<body>
	...
	<div class="container">
		...
		<form action="/CollegeFestival/students/search" class="form-inline">

			<!-- Add a button -->
			<a href="/CollegeFestival/students/showFormForAdd"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/CollegeFestival/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/CollegeFestival/students/delete?studentId=${tempStudent.id}"
